...
{
public:
    //Camera's settings : position in spherical coords (dist,lon,lat), vertical field of view (fov) and distance constraints (min_dist, max_dist).
    ...
    void set_projection(const float win_aspect_ratio)
    {
