...
//Note : If the zero quaternion is set as input, in the gui (properties panel), this function will NOT be executed.
//Instead, the user will be prompted to reset the quaternion due to validate().
...
//Calculate the eccentric anomaly, given the mean anomaly. The calculation is done by
