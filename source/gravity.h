...
{   
    ...
    //F = -grad(V)
    dvec3 force = -(dV_dd*dd_dr + dV_dl1*dl1_dr + dV_dm1*dm1_dr + dV_dn1*dn1_dr +
                                  dV_dl2*dl2_dr + dV_dm2*dm2_dr + dV_dn2*dn2_dr);

    dvec3 dl1_da1 = ru, dm1_da2 = ru, dn1_da3 = ru;
    dvec3 dV_da1 = dV_dl1*dl1_da1;
    dvec3 dV_da2 = dV_dm1*dm1_da2;
    dvec3 dV_da3 = dV_dn1*dn1_da3;

    dvec3 tau1 = -cross(a1, dV_da1) - cross(a2, dV_da2) - cross(a3, dV_da3);
                                                     ...
                                                     const double M2, const dtens &J2, const dmat3 &A2)
{
    ...
    dvec3 dc11_da1 = b1, dc21_da2 = b1, dc31_da3 = b1;
    dvec3 dc12_da1 = b2, dc22_da2 = b2, dc32_da3 = b2;
    dvec3 dc13_da1 = b3, dc23_da2 = b3, dc33_da3 = b3;
