...
/*
//Classical Keplerian mutual potential of 2 point masses (or rigid spheres).
double mut_pot_kep(const dvec3 &r, const double M1, const double M2)
{
    return -G*M1*M2/sqrt(r[0]*r[0] + r[1]*r[1] + r[2]*r[2]);
}
*/
...
/*
//Classical Keplerian force of 2 point masses (or rigid spheres).
dvec3 mut_force_kep(const dvec3 &r, const double M1, const double M2)
{
    double d = sqrt(r[0]*r[0] + r[1]*r[1] + r[2]*r[2]);
    return -G*M1*M2*dvec3{r[0],r[1],r[2]}/(d*d*d);
}
*/
...
dvec3 mut_torque_integrals_ord4(const dvec3 &r,                  const dtens &J1, const dmat3 &A1,
                                                const double M2, const dtens &J2, const dmat3 &A2)
{
    double J1xx = J1[2][0][0];
    double J1yy = J1[0][2][0];
...
/*
//Mutual gravity gradient torque of 2 rigid bodies, assuming mascon distributions with constant densities.
