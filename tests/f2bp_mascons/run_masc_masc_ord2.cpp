...
void odes(const boost::array<double, 20> &state, boost::array<double, 20> &dstate, double /*t*/)
{
    ...
    dvec6 force_and_tau1i = mut_force_tau1i_integrals_ord2(r, pars.M1,pars.J1,A1, pars.M2,pars.J2,A2);
...
int main()
{
    ...
    pars.J1 = masc1.get_inertial_integrals(pars.M1, 2);
    ...
    pars.J2 = masc2.get_inertial_integrals(pars.M2, 2);  
    ...
    FILE *file_t      = fopen("io/mmo2_time.txt","w");
    FILE *file_pos    = fopen("io/mmo2_rel_pos.txt","w");
    FILE *file_vel    = fopen("io/mmo2_rel_vel.txt","w");
    FILE *file_kep    = fopen("io/mmo2_rel_kep.txt","w");
    FILE *file_q1     = fopen("io/mmo2_quaternion1.txt","w");
    FILE *file_w1b    = fopen("io/mmo2_ang_vel_w1b.txt","w");
    FILE *file_q2     = fopen("io/mmo2_quaternion2.txt","w");
    FILE *file_w2b    = fopen("io/mmo2_ang_vel_w2b.txt","w");
    FILE *file_rpy1   = fopen("io/mmo2_euler_rpy1.txt","w");
    FILE *file_w1i    = fopen("io/mmo2_ang_vel_w1i.txt","w");
    FILE *file_rpy2   = fopen("io/mmo2_euler_rpy2.txt","w");
    FILE *file_w2i    = fopen("io/mmo2_ang_vel_w2i.txt","w");
    FILE *file_EL_err = fopen("io/mmo2_ener_mom_rel_error.txt","w");
    ...
    for (size_t i = 0; i < orbit.size(); ++i)
    {
        ...
        double energy = 0.5*pars.m*dot(v,v) + 0.5*dot( dot(w1b,pars.I1), w1b) + 0.5*dot( dot(w2b,pars.I2), w2b) + mut_pot_integrals_ord2(r, pars.M1,pars.J1,A1, pars.M2,pars.J2,A2);
    ...
    FILE *file_collision = fopen("io/mmo2_collision.txt","w");
