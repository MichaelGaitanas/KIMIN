...
void odes(const boost::array<double, 20> &state, boost::array<double, 20> &dstate, double t)
{
    ...
    dvec3 force = mut_force_integrals_ord3(r, M1,J1,A1, M2,J2,A2);

    dvec3 tau1i = mut_torque_integrals_ord3(r, J1,A1, M2);
...
int main()
{
    ...
    J1 = masc1.get_inertial_integrals(M1, 3);
    ...
    J2 = masc2.get_inertial_integrals(M2, 3); 
    ...
    FILE *file_w2b    = fopen("io/mmo3_ang_vel_w2b.txt","w");
    FILE *file_rpy1   = fopen("io/mmo3_euler_rpy1.txt","w");
    FILE *file_w1i    = fopen("io/mmo3_ang_vel_w1i.txt","w");
    FILE *file_rpy2   = fopen("io/mmo3_euler_rpy2.txt","w");
    FILE *file_w2i    = fopen("io/mmo3_ang_vel_w2i.txt","w");
    FILE *file_EL_err = fopen("io/mmo3_ener_mom_rel_error.txt","w");
    ...
    for (size_t i = 0; i < orbit.size(); ++i)
    {
        ...
        double energy = 0.5*m*dot(v,v) + 0.5*dot( dot(w1b,I1), w1b) + 0.5*dot( dot(w2b,I2), w2b) + mut_pot_integrals_ord3(r, M1,J1,A1, M2,J2,A2);
    ...
    FILE *file_collision = fopen("io/mmo3_collision.txt","w");
