...
void odes(const boost::array<double, 20> &state, boost::array<double, 20> &dstate, double /*t*/)
{
    ...
    dvec6 force_and_tau1i = mut_force_tau1i_integrals_ord3(r, pars.M1,pars.J1,A1, pars.M2,pars.J2,A2);
...
int main()
{
    ...
    pars.J1 = masc1.get_inertial_integrals(pars.M1, 3);
    ...
    pars.J2 = masc2.get_inertial_integrals(pars.M2, 3);  
