...
int main()
{
    ...
    FILE *file_w2b    = fopen("io/mme_ang_vel_w2b.txt","w");
    FILE *file_rpy1   = fopen("io/mme_euler_rpy1.txt","w");
    FILE *file_w1i    = fopen("io/mme_ang_vel_w1i.txt","w");
    FILE *file_rpy2   = fopen("io/mme_euler_rpy2.txt","w");
    FILE *file_w2i    = fopen("io/mme_ang_vel_w2i.txt","w");
    FILE *file_EL_err = fopen("io/mme_ener_mom_rel_error.txt","w");
    ...
    FILE *file_collision = fopen("io/mme_collision.txt","w");
